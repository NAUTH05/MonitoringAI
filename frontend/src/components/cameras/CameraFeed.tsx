    ...
    <>
      ...
      {isPopupOpen &&
        ...
        createPortal(
          ...
          >
            <div
              className="relative w-full max-w-[90rem] h-[85vh] bg-neutral-950 border border-neutral-800 rounded-2xl overflow-hidden flex flex-col shadow-2xl animate-in zoom-in-95 duration-150"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Modal Header Bar */}
